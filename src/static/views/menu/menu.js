...
;pug_debug_line = 5;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + "Simple Game\n  \u003C\u002Ftitle\u003E";
;pug_debug_line = 11;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Flayout\u002Fmain.pug";
;pug_debug_line = 8;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('  ');
...
;pug_debug_line = 11;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + "\n  \u003Cdiv\u003E";
;pug_debug_line = 12;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_mixins["menuList"] = pug_interp = function(link, item){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 13;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + "\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdl class=\"menu\"\u003E";
;pug_debug_line = 14;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + "\n      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdt\u003E";
;pug_debug_line = 15;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + "\u003Ca" + (pug_attr("href", link, true, false)) + "\u003E";
;pug_debug_line = 15;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = item) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fdt\u003E\n    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdl\u003E";
};
;pug_debug_line = 17;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('    ');
pug_mixins["menuList"]('signup', 'Sign up');
pug_indent.pop();
;pug_debug_line = 18;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('    ');
pug_mixins["menuList"]('signin', 'Sign in');
pug_indent.pop();
;pug_debug_line = 19;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('    ');
pug_mixins["menuList"]('leaders', 'Leaders');
pug_indent.pop();
;pug_debug_line = 20;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('    ');
pug_mixins["menuList"]('profile', 'Profile');
pug_indent.pop();
;pug_debug_line = 21;pug_debug_filename = "src\u002Fstatic\u002Fviews\u002Fmenu\u002Fmenu.pug";
pug_indent.push('    ');
