...
pug_html = pug_html + "\u003Ca" + (" class=\"active\""+pug_attr("href", 'leaders/'+index, true, false)+pug_attr("title", titleName, true, false)+pug_attr("name", pageName, true, false)) + "\u003E";
;pug_debug_line = 35;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
...
pug_html = pug_html + "\u003Ca" + (pug_attr("href", 'leaders/'+index, true, false)+pug_attr("title", b, true, false)+pug_attr("name", pageName, true, false)) + "\u003E";
;pug_debug_line = 37;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = index) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
}
}
