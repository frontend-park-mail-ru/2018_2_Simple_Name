...
pug_html = pug_html + "\u003Cbutton" + (" title=\"Prev page\""+pug_attr("name", index, true, false)) + "\u003E";
;pug_debug_line = 27;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
...
pug_html = pug_html + "\u003Cbutton" + (" class=\"button-ref active\""+pug_attr("title", titleName, true, false)+pug_attr("name", pageName, true, false)) + "\u003E";
;pug_debug_line = 35;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = index) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E";
}
else {
;pug_debug_line = 37;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + "\u003Cbutton" + (" class=\"button-ref\""+pug_attr("title", b, true, false)+pug_attr("name", pageName, true, false)) + "\u003E";
;pug_debug_line = 37;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = index) ? "" : pug_interp)) + "\u003C\u002Fbutton\u003E";
}
}
;pug_debug_line = 40;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + "\u003Cbutton title=\"Next page\"\u003E";
;pug_debug_line = 40;pug_debug_filename = "src\u002Fviews\u002Fscoreboard\u002FscoreboardTemplate.pug";
pug_html = pug_html + "▶\u003C\u002Fbutton\u003E";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
