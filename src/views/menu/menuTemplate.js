...
pug_html = pug_html + "\u003Cdiv\u003E";
;pug_debug_line = 23;pug_debug_filename = "src\u002Fviews\u002Fmenu\u002FmenuTemplate.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = errText) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fbody\u003E";}.call(this,"errText" in locals_for_with?locals_for_with.errText:typeof errText!=="undefined"?errText:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}